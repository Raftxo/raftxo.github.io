    ...
    class Player {
        ...
        update(input, deltaTime, enemies){
            ...
            enemies.forEach(enemy => {
                ...
                if (distance < enemy.width/3.1 + this.width/3.1){
                    gameOver = true;
                }
            });
            // sprite animation
    ...
    function toggleFullScreen(){
        ...
        if (!document.fullscreenElement) {
            canvas.requestFullscreen().catch(err => {
                alert(`texto de cadena de caracteres ${err.message} texto adicional`);
            });
        } else {
